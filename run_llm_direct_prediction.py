...
from agents import LLMDirectPredictionAgent
...
def main(args):
    ...
    direct_prediction_agent = LLMDirectPredictionAgent(model_name=args.prediction_model, dataset_name=DATASET_NAME)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--dataset_name', type=str, default='traffic', choices=ALL_LABEL_MEANINGS.keys(),
    ...
    parser.add_argument(
        '--output_file', type=str, default='llm_direct_predictions.csv',
